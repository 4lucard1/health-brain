      ...
      <div style={{ flex: 1, overflowY: 'auto', padding: '20px 16px' }}>
        <div style={{ display: 'flex', alignItems: 'center', gap: '12px', marginBottom: '20px' }}>
          <button onClick={() => setSelectedRecord(null)}
            style={{ backgroundColor: 'rgba(255,255,255,0.04)', border: '1px solid rgba(255,255,255,0.08)', borderRadius: '12px', padding: '8px 16px', color: '#F5F5F5', cursor: 'pointer', fontSize: '14px' }}>← Back</button>
          <div>
        ...
        <div style={{ backgroundColor: 'rgba(34,197,94,0.05)', border: '1px solid rgba(34,197,94,0.2)', borderRadius: '20px', padding: '20px', marginBottom: '16px', boxShadow: '0 0 30px rgba(34,197,94,0.05)' }}>
        ...
        {selectedRecord.extracted_text && (
          <div style={{ backgroundColor: 'rgba(255,255,255,0.03)', border: '1px solid rgba(255,255,255,0.06)', borderRadius: '20px', padding: '20px' }}>
            <p style={{ fontSize: '13px', fontWeight: 600, color: '#9CA3AF', marginBottom: '12px' }}>Extracted Data</p>
    ...
    <div style={{ flex: 1, overflowY: 'auto', padding: '20px 16px' }}>
      ...
      <div style={{ backgroundColor: 'rgba(255,255,255,0.03)', border: '1px solid rgba(255,255,255,0.07)', borderRadius: '20px', padding: '16px', marginBottom: '16px' }}>
        ...
        <motion.button whileHover={{ scale: 1.01 }} whileTap={{ scale: 0.99 }} onClick={() => fileRef.current?.click()}
          style={{ width: '100%', padding: '28px', border: '2px dashed rgba(34,197,94,0.25)', borderRadius: '16px', backgroundColor: 'rgba(34,197,94,0.04)', color: '#22C55E', fontSize: '14px', cursor: 'pointer' }}>
            ...
            <AnimatePresence>
              {records.map((record, i) => (
                <motion.button key={record.id}
                  ...
                  style={{ width: '100%', backgroundColor: 'rgba(255,255,255,0.03)', border: '1px solid rgba(255,255,255,0.07)', borderRadius: '16px', padding: '14px 16px', cursor: 'pointer', textAlign: 'left' }}>
